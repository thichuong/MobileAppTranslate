...
class ObjectDetectorPainter extends CustomPainter {
  ObjectDetectorPainter(this._objects, this.rotation, this.absoluteSize,this.listTextFrom,this.listTextTo);

  final List<DetectedObject> _objects;
  final Size absoluteSize;
  final InputImageRotation rotation;
  final List<String> listTextFrom;
  final List<String> listTextTo;
  @override
  void paint(Canvas canvas, Size size) {
    ...
    for (final DetectedObject detectedObject in _objects) {
      ...
      for (final Label label in detectedObject.labels) {
        builder.addText('${listTextFrom[i]} : ${listTextTo[i]}\n');
        i++;
      }
